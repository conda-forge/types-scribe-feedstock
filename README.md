...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/types-scribe-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13195&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/types-scribe-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `types-scribe` can be installed with:

```
conda install types-scribe
```

It is possible to list all of the versions of `types-scribe` available on your platform with:
